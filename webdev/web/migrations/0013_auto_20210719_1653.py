...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='category',
            name='title',
            field=models.CharField(default='', max_length=255, verbose_name='دسته بندی'),
        ),
        ...
        migrations.AlterField(
            model_name='blog',
            name='slug',
            field=models.SlugField(allow_unicode=True, max_length=20, unique=True, verbose_name='نامک'),
        ),
        migrations.AlterField(
            model_name='blog',
            name='status',
