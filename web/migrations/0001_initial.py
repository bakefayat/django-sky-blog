# Generated by Django 3.2.6 on 2022-02-04 21:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children', to='web.category', verbose_name='دسته والد')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ManyToManyField(related_name='articles', to='web.Category', verbose_name='دسته بندی')),
            ],
            options={
                'verbose_name': 'مقاله',
